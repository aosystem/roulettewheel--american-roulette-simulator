...
import 'package:roulettewheel/parse_locale_tag.dart';
import 'package:roulettewheel/theme_mode_number.dart';
import 'package:roulettewheel/theme_color.dart';
import 'package:roulettewheel/model.dart';
import 'package:roulettewheel/text_to_speech.dart';
import 'package:roulettewheel/l10n/app_localizations.dart';
...
import 'package:roulettewheel/main.dart';
...
class _MainHomePageState extends State<MainHomePage> {
  ...
  void _resultNumber() {
    ...
    angle = ((angle - _wheelAngleStart + _adjustAngle) / (360 / 38)).toInt() * (360 / 38) + (180 / 38);
    angle = 180 - angle;
    angle += 3600;
    angle %= 360;
